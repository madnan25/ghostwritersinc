...
export function EditPostDialog({ postId, initialContent, className }: EditPostDialogProps) {
  ...
  return (
    <>
      <Button variant="outline" size="sm" onClick={handleOpen} className={cn("min-h-[44px] px-4 sm:min-h-0", className)}>
        Edit
      </Button>
