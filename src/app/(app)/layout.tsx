  ...
  return (
    <div className="premium-shell flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 border-b border-border/55 bg-background/62 backdrop-blur-xl">
        <nav className="container relative flex h-20 items-center px-4 md:px-6">
          <div className="shrink-0">
            <BrandWordmark compact />
          </div>
          <div className="absolute left-1/2 hidden -translate-x-1/2 items-center gap-0.5 rounded-full border border-border/60 bg-card/52 p-1 text-[0.82rem] font-medium tracking-[-0.01em] shadow-[0_10px_30px_-18px_rgba(0,0,0,0.55)] md:flex">
            {[
